...
| urd.tree.rds              | Zenodo, upon request |
| P21_adult.integrated.rds  | Zenodo, upon request |  
| STICR.CeA.Integrated.rds  | Zenodo, upon request |
| Human.MouseDev.Merged.rds | Zenodo, upon request |
| Human.CeA.consensus.rds   | Zenodo, upon request |
| Human.MouseAdult.Integrated.rds | Zenodo, upon request |
